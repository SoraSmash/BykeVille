...
public partial class Address
{
    ...
    public Address(int addressId, string addressLine1, string? addressLine2, string city, string stateProvince, string countryRegion, string postalCode, Guid rowguid, DateTime modifiedDate)
    {
        AddressId = addressId;
